...
public class Client
{
    public static void main(String[] args)
    {
        ...
        //都为 系统的类加载器
        System.out.println("proxy.getClass().getClassLoader(): "+handler.getClass().getClassLoader());
        System.out.println("realSub.getClass().getClassLoader(): "+realSubject.getClass().getClassLoader());
