...
import com.dubbowork.qrz.netty.threadnio.NioServerBoss;
import com.dubbowork.qrz.netty.threadnio.NioServerWorker;

/**
 * selector线程管理者 调度类 NIO并不能简单的把selector.select() 放入线程类中
 * @author邱润泽
 *
 */
